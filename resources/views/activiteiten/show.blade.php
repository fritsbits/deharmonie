...
<div style="background: white; padding: 2rem 1.5rem 1.5rem;">
    <div style="max-width: 72rem; margin: 0 auto; padding: 0 1.5rem;">
        ...
        <a href="{{ route(app()->getLocale() . '.activiteiten.index') }}"
           ...
           style="color: var(--color-brand-blue); font-size: 1rem; padding: 0.5rem 0; display: inline-block;">
            {{ __('activities.back') }}
        </a>
        ...
        @if ($activiteit->status->value === 'geannuleerd')
            <div class="rounded-lg p-4 mt-4 font-semibold"
                 style="background-color: rgba(235,102,67,0.1); color: #a03520; border: 1px solid rgba(235,102,67,0.3); font-size: 1rem;">
        ...
        <div style="margin-top: 1.25rem;">
            ...
            <span
                ...
                "
                x-show="booked"
                style="display: none; background: var(--color-brand-green); color: white; font-size: 0.875rem; font-weight: 700; padding: 0.2rem 0.6rem; border-radius: 4px; font-family: var(--font-sans); letter-spacing: 0.04em; text-transform: uppercase; vertical-align: middle; margin-left: 0.5rem;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem 2.5rem; margin-top: 1.5rem;">
            ...
            <div style="display: flex; align-items: flex-start; gap: 0.75rem; margin-bottom: 0.5rem;">
                ...
                <div>
                    <p style="font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: var(--color-brand-green-mid); margin: 0 0 0.2rem; font-family: var(--font-sans);">{{ __('activities.date') }}</p>
            ...
            <div style="display: flex; align-items: flex-start; gap: 0.75rem; margin-bottom: 0.5rem;">
                ...
                <div>
                    <p style="font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: var(--color-brand-green-mid); margin: 0 0 0.2rem; font-family: var(--font-sans);">{{ __('activities.price') }}</p>
            ...
            <div style="display: flex; align-items: flex-start; gap: 0.75rem; margin-bottom: 0.5rem;">
                ...
                <div>
                    <p style="font-size: 0.8125rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.07em; color: var(--color-brand-green-mid); margin: 0 0 0.2rem; font-family: var(--font-sans);">{{ __('activities.location') }}</p>
...
<div style="max-width: 72rem; margin: 0 auto; padding: 2.5rem 1.5rem 4rem;">
    ...
    @elseif ($activiteit->status->value === 'geannuleerd')
        <p style="font-size: 1rem; font-style: italic; color: var(--color-brand-muted)">
