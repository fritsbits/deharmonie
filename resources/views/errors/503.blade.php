...
<head>
    ...
    <title>{{ $isFr ? 'Maintenance en cours' : 'Even offline voor onderhoud' }} — De Harmonie</title>
...
<body>
    ...
    <main class="content">
        ...
        <p style="color: #706662; max-width: 36rem; margin: 0 0 1.75rem;">
            We bricoleren even achter de schermen. Heb je dringend iets nodig? Bel ons gerust.
        </p>

        <a href="tel:+3222032848"
           style="display: inline-flex; align-items: center; gap: 0.5rem; font-family: 'Nunito Sans', sans-serif; font-size: 1.5rem; font-weight: 900; color: #2c2826; text-decoration: none;">
        ...
        <p style="color: #706662; font-size: 1rem; max-width: 36rem; margin: 0 0 1rem;">
            On bricole un peu en coulisses. Pour toute urgence, appelez-nous.
        </p>
